  ...
  var sure = function () {
              ...
              botui.message
                ...
                .then(function () {
                  botui.message
                    .add({
                      delay: 1500,
                      content: "主要学习过的技术CSS/JavaScript/JQuery/Vue",
                    })
                    .then(function () {
                      botui.message
                        .add({
                          delay: 1500,
                          content: "不过平时什么都喜欢折腾，了解",
                        })
                        .then(function () {
                          botui.message
                            .add({
    ...
    thirdpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content:
            "月光温柔，平淡，也寄托了相思，月亮也是一个富有神话色彩的东西~",
        })
        .then(function () {
          botui.action
            .button({
    ...
    fifthpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content: "emmmm，好奇就想了解了解，试试嘛",
        })
        .then(function () {
          botui.message.add({
            delay: 1600,
            content: "说了这么多.那么快去看看我的博客吧～",
          });
        });
    };
  return botui;
