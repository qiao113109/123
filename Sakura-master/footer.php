...
<script src="https://cdn.jsdelivr.net/gh/fz6m/Private-web@1.4/js/custom/slide.js"></script>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<p style="font-family: 'Ubuntu', sans-serif;">
			...
			<!-- 备案信息 -->
					© 2020 Moon <a href="http://www.beian.miit.gov.cn/" target="_blank" style="color:  rgba(0,0,0,.4);;text-decoration:none">豫ICP备20009876号</a>
			</p>
			<!-- 底部图标 -->
